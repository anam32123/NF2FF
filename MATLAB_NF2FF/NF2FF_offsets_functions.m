%% what I've accomplished: writing a couple of functions, producing a plot of residuals, and calculating residuals with percent error
% 
...
%     end
    ...
    [f_X_Rectangular,f_Y_Rectangular,f_Z_Rectangular,f_X_Rectangular_Magnitude,f_Y_Rectangular_Magnitude,f_Z_Rectangular_Magnitude]=NFtoFourierSpace(NF_X_Complex,NF_Y_Complex,k_X_Rectangular_Grid,k_Y_Rectangular_Grid,k_Z_Rectangular_Grid);

    [f_X_Rectangular,f_Y_Rectangular,f_Z_Rectangular_Offset,f_X_Rectangular_Magnitude,f_Y_Rectangular_Magnitude,f_Z_Rectangular_Offset_Magnitude]=NFtoFourierSpace(NF_X_Complex,NF_Y_Complex,k_X_Rectangular_Offset_Grid,k_Y_Rectangular_Offset_Grid,k_Z_Rectangular_Offset_Grid);
...
function [error_amplitude,error_phase,mean_amplitude_error,max_amplitude_error,mean_amplitude_percent_error,max_amplitude_percent_error,mean_phase_error,max_phase_error,mean_phase_percent_error,max_phase_percent_error]=complex_error(original_field,offset_field,x,y,label_1,label_2)

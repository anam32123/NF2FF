...
Etheta_NaN_indices=find(isnan(all_Etheta_errors.weighted_percent_difference_mean_amplitudes));
Ephi_NaN_indices=find(isnan(all_Ephi_errors.weighted_percent_difference_mean_amplitudes));

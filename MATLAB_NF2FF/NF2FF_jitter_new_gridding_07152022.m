%% Beginning of jitter experiment with the flipped about gridding
...
% 
    ...
    Etheta_error_metrics=complex_error(Etheta,Etheta_jittered,theta,phi,'theta','phi');
    fprintf('E_phi errors:\n');
    Ephi_error_metrics=complex_error(Ephi,Ephi_jittered,theta,phi,'theta','phi');

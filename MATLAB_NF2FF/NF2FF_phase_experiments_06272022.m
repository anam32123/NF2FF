...
for f_Index = 201:1:201 %1:1:N Only does this at the 201st frequency?? why--maybe only interested in one frequency and you can adjust it
    ...
    f=freq(f_Index);
    lambda0=c/f;
%     FF_Dist=2* --can't do this right now because I don't know D
    k0=2*pi/lambda0;
...
%% Holographic back projection to the near field
...
%% phase information
    ...
    Hologram_X_Phase1=angle(Hologram_X_Complex);
    Hologram_Y_Phase1=angle(Hologram_Y_Complex);
    Hologram_Z_Phase1=angle(Hologram_Z_Complex);

...
x_offsets=linspace(0,max_drift,M);
y_offsets=linspace(0,max_drift,N);
...
for f_Index = 201:1:201 %1:1:N Only does this at the 201st frequency?? why--maybe only interested in one frequency and you can adjust it
    ...
    % interpolating the data to get the drifted version
    NF_X_drifted_Complex=interp2(x,y,NF_X_Complex,x_drifted_grid,y_drifted_grid);
    NF_Y_drifted_Complex=interp2(x,y,NF_Y_Complex,x_drifted_grid,y_drifted_grid);
